    ...
    return Scaffold(
      ...
      body: SmartRefresher(
        ...
        child: SafeArea(
          ...
          child: Consumer<AllDonationsService>(
            builder: (context, provider, child) => provider.hasDonation == true
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      CommonHelper().titleCommon(
                                          provider.allDonations[i].cause.title),
                                      sizedBoxCustom(3),
                                      ConstStyles().capsule(
                                        provider.allDonations[i].status ?? '-',
                                      ),
                                      sizedBoxCustom(19),
                                      ConstStyles().commonRow('Donations ID',
                                      ...
                                      ConstStyles().commonRow(
                                          ...
                                          removeUnderscore(provider
                                              .allDonations[i].paymentGateway)),
                                      ConstStyles().commonRow(
                                          'Date',
                                          CampaignDetailsService().formatDate(
                                              provider
                                                  .allDonations[i].createdAt),
                                          lastBorder: true),
                                    ]),
                              )
                          ]),
                ...
                : Container(
                    ...
                    child: Text('No donation record found'),
                  ),
          ),
        )),
      ),
