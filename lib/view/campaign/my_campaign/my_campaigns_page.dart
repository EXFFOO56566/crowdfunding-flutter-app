          ...
          builder: (context, provider, child) => provider.isLoading == false
              ? provider.myCampaignList.isNotEmpty
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return MyCampaignCard(
                                imageLink: provider.myCampaignList[index].image,
                                title: provider.myCampaignList[index].title,
                                desc:
                                    provider.myCampaignList[index].causeContent,
                                categoryId:
                                    provider.myCampaignList[index].categoriesId,
                                endDate:
                  ...
                  : Container(
                      ...
                      child: const Text('You don\'t have any campaign'),
                    )
              : Container(
                  height: screenHeight - 120,
                  alignment: Alignment.center,
