...
import 'package:tochyodikwa/model/all_events_model.dart';
import 'package:tochyodikwa/model/event_details_model.dart';
...
class AllEventsService with ChangeNotifier {
  ...
  fetchAllEventsList(context, {bool isrefresh = false}) async {
    if (isrefresh) {
      ...
      Provider.of<AllEventsService>(context, listen: false)
