  ...
  switch (method) {
    case 'paypal':
      makePaymentToGetOrderId(context, () {
        PaypalService().payByPaypal(context, isFromEventBook: false);
      },
    ...
    case 'cashfree':
      makePaymentToGetOrderId(context, () {
        CashfreeService().getTokenAndPay(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
    ...
    case 'flutterwave':
      makePaymentToGetOrderId(context, () {
        FlutterwaveService().payByFlutterwave(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
    ...
    case 'midtrans':
      makePaymentToGetOrderId(context, () {
        MidtransService().payByMidtrans(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
    ...
    case 'cinetpay':
      makePaymentToGetOrderId(context, () {
        CinetPayService().payByCinetpay(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
    ...
    case 'razorpay':
      makePaymentToGetOrderId(context, () {
        RazorpayService().payByRazorpay(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
    ...
    case 'stripe':
      makePaymentToGetOrderId(context, () {
        StripeService().makePayment(context, isFromEventBook: false);
      },
          selectedPaymentName: method,
          campaignId: campaignId,
          name: name,
